...
export default function AccelerationGraph() {
  ...
  return (
    <div style={cardStyle}>
      ...
      <div style={{ display: 'flex', gap: '10px', marginBottom: '15px', zIndex: 10, flexWrap: 'wrap', alignItems: 'center' }}> 
        <DatePicker
          selected={startDate}
        ...
        <button 
          ...
          style={{ padding: '6px 12px', borderRadius: '5px', background: '#0066cc', color: '#fff', border: 'none', cursor: 'pointer' }}
        >
          Apply Filter
        </button>
        <button 
